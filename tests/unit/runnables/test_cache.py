...
@persista_available
def test_caching_runnable_invoke_caches_none_result() -> None:
...
@persista_available
def test_caching_runnable_ainvoke_caches_none_result() -> None:
    inner = TrackingRunnable(none_on="a")
    with Cache() as cache:
        cached = CachingRunnable(runnable=inner, cache=cache, key_fn=_identity_key)
...
@persista_available
def test_caching_runnable_batch_mixed_none_and_non_none_results() -> None:
...
@persista_available
def test_caching_runnable_abatch_mixed_none_and_non_none_results() -> None:
    inner = TrackingRunnable(none_on="b")
    with Cache() as cache:
        cached = CachingRunnable(runnable=inner, cache=cache, key_fn=_identity_key)
