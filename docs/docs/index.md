...
the [contributing guidelines](https://github.com/durandtibo/zenpyre/blob/main/CONTRIBUTING.md) for
details on:
...
:warning: **Important**: As `zenpyre` is under active development, its API is not yet stable and may
change between releases. We recommend pinning a specific version in your project’s dependencies to
ensure consistent behavior.

## License

`zenpyre` is licensed under BSD 3-Clause "New" or "Revised" license available
in [LICENSE](https://github.com/durandtibo/zenpyre/blob/main/LICENSE)
file.
